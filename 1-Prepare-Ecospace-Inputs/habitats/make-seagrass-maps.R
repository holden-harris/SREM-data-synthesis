...
#set directories
dir.depth = paste0("./0-Data/habitats/processed/crm-resolutions/")
...
#seagrass 2001----------------------------------------------------------------------
sg01.shp <- shapefile("./0-Data/habitats/inputs/seagrass2001_SRWMD/seagrass01.shp")
...
png("./0-Data/habitats/plots/seagrasses-continous-patch.png", 6.5, 6.5, units = "in", res = 200)
...
dir.out = "./0-Data/habitats/processed/saltmarsh-rasters/"
